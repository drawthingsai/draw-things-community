...
root_article = Path("Libraries/MediaGenerationKit/Sources/MediaGenerationKit.docc/MediaGenerationKit.md")
root_article.write_text(root_article.read_text().replace("_MediaGenerationKit/", "MediaGenerationKit/"))
PY
