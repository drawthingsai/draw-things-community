...
public struct EchoRequest: Sendable {
  ...
  public var requestFiles: Bool = false
...
extension EchoRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try { try decoder.decodeSingularBoolField(value: &self.requestFiles) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if self.requestFiles != false {
      try visitor.visitSingularBoolField(value: self.requestFiles, fieldNumber: 2)
    }
  ...
  public static func ==(lhs: EchoRequest, rhs: EchoRequest) -> Bool {
    ...
    if lhs.requestFiles != rhs.requestFiles {return false}
