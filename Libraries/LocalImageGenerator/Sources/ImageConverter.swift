      ...
      tensor.withUnsafeBytes {
        ...
        case .hunyuanVideo:
          ...
          for i in 0..<imageHeight * imageWidth {
            ...
            // TBD, I may want to regress these coefficients myself.
            let r: FloatType =
              (-0.041 * v0 - 0.26 * v1 - 0.37 * v2 - 0.04 * v3 - 0.52 * v4 - 0.56 * v5
                - 0.53 * v6 - 0.51 * v7 - 0.59 * v8 - 0.56 * v9 - 0.61 * v10 - 0.05
                * v11 - 0.23 * v12 - 0.51 * v13 - 0.13 * v14 - 0.01 * v15) * 127.5 + 127.5
            let g: FloatType =
              (-0.25 * v0 - 0.49 * v1 - 0.54 * v2 - 0.29 * v3 - 0.59 * v4 - 0.6 * v5
                - 0.06 * v6 - 0.28 * v7 - 0.1 * v8 - 0.54 * v9 - 0.19 * v10 - 0.25
                * v11 - 0.04 * v12 - 0.56 * v13 - 0.4 * v14 - 0.01 * v15) * 127.5 + 127.5
            let b: FloatType =
              (-0.26 * v0 - 0.24 * v1 - 0.3 * v2 - 0.29 * v3 - 0.39 * v4 - 0.02 * v5
                - 0.48 * v6 - 0.18 * v7 - 0.33 * v8 - 0.41 * v9 - 0.5 * v10 - 0.17
                * v11 - 0.22 * v12 - 0.43 * v13 - 0.05 * v14 - 0.48 * v15) * 127.5 + 127.5
            bytes[i * 4] = UInt8(min(max(Int(r.isFinite ? r : 0), 0), 255))
            bytes[i * 4 + 1] = UInt8(min(max(Int(g.isFinite ? g : 0), 0), 255))
            bytes[i * 4 + 2] = UInt8(min(max(Int(b.isFinite ? b : 0), 0), 255))
            bytes[i * 4 + 3] = 255
