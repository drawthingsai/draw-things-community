// Source: Ideogram's open-source Magic Prompt v1 [SYSTEM] section:
// https://github.com/ideogram-oss/ideogram4/blob/main/src/ideogram4/magic_prompt_system_prompts/v1.txt
// Ideogram tests this reference prompt with Claude Opus and notes that it differs from the
// production Magic Prompt API; Draw Things runs it locally with Qwen 3.5 9B.
let Ideogram4MagicSystemPrompt = #"""
